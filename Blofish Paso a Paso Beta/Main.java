...
public class Blow {
    ...
    Main()
    {
        ...
        for (int i = 0; i < 32; i++)
          ...
          // Inicializa un objeto Scanner para la entrada estándar
          Scanner scanner = new Scanner(System.in);

          // Solicita al usuario que ingrese el texto a cifrar
          ...
          // Cierra el objeto Scanner después de usarlo
          scanner.close();
  
          // Continúa con el cifrado
          keyGenerate(key);
